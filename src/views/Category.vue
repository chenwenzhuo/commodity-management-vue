...
export default {
    ...
    methods: {
        ...
        hideDialog() {
            this.dialogVisible = 0;//隐藏对话框
            //清空表单
            this.$refs.modifyCateForm && this.$refs.modifyCateForm.resetFields();
            this.$refs.addCateForm && this.$refs.addCateForm.resetFields();
        }
    },
    mounted() {
        //组件挂载时发送请求查询分类数据
